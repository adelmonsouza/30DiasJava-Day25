# Day 25/30 — Batch Processing

**#30DiasJava Challenge**

Spring Batch, jobs e processamento assíncrono
...
Leia o artigo completo: [Day 25/30 — Batch Processing](https://enouveau.io/blog/2025/11/25/Batch-Processing.html)
...
```bash
git clone https://github.com/adelmonsouza/30DiasJava-Day25.git
cd 30DiasJava-Day25
```
...
# Ou via Docker
docker run -d --name postgres-day25 \
  -e POSTGRES_DB=day25_db \
  -e POSTGRES_USER=dev \
...
- [Artigo no Blog](https://enouveau.io/blog/2025/11/25/Batch-Processing.html)
